...
- The [[ref:Output Descriptor Object]] ****MUST**** contain a `version` property, and its value ****MUST**** be a valid semantic version according to the rules set in the [versioning section](#versioning).
