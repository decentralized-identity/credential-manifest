...
- The `credential_fulfillment` object ****MUST**** contain an `application_id` property. The value of this property ****MUST**** be the `id` value of a valid [[ref:Credential Application]].
